...
as this poses significant algorithmic and statistical challenges, by involving exponentially-many potentially important multi-variate  interactions. %, for which non-linear or multi-variate analytics is necessary.  
