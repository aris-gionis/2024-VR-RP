...
\section{Purpose and aims {\color{orange}[$\approx$1.5 pages]}}
...
\section{State of the art {\color{orange}[$\approx$1 page]}}

\instructions{
Summarise briefly the current research frontier within the field or area covered by the project. State key references.
}

\section{Significance and scientific novelty  {\color{orange}[$\approx$0.5 page]}}
...
\section{Preliminary and previous results  {\color{orange}[$\approx$0.5 page]}}
...
\subsection*{Research theme 2 (\rtw): \clusterings\ {\color{orange}[$\approx$1 page]}}
...
\subsection*{Research theme 3 (\rth): \labels\ {\color{orange}[$\approx$1 page]}}

Last, we focus on methods for explaining clusterings using labels as descriptors


\subsection{Time plan and implementation {\color{orange}[$\approx$0.75-1 page]}}
...
\subsection{Project organization {\color{orange}[$\approx$0.5 page]}}
...
\section{Equipment {\color{orange}[$\approx$0.2 page]}}

\instructions{
Describe the basic equipment you and your team have at your disposal for the project.
}

\section{Need for research infrastructure {\color{orange}[$\approx$0.2 page]}}
