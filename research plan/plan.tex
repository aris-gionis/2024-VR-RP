...
% Rece propose enhancements to the original IMM algorithm \cite{moshkovitz2020explainable}. 
% In the seminal work \citet{moshkovitz2020explainable} explained $k$-means and $k$-median with axis-aligned decision trees and derived a worst-case approximaton gauarantee, coined by the name price of explainability, which has been inspired by the price of interpretability \cite{bersimas2019} for axis-aligned decision tree classification. 
...
Other research on explainable clustering employ combinatorial optimization to describe polyhedral descriptions of the boundaries of clusters \cite{lawless2023polyhedral}. 
