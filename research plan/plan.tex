...
% ---as depicted in Figure~\ref{fig:iris}, 
including explaining using similarity-based prototypes for each cluster 
%\cite{carrizosa2022interpreting}, 
...
Those include allowing for outliers that can help to significantly reduce the clustering cost.
...
The PI has relevant experience of developing methods for finding the labeled-induced
