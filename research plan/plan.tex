...
Although there is a rich body of research on measuring the importance of individual features, such as Shapley values~\cite{} or impurity~\cite{}; we hypothesize that \emph{interactions between features} are highly relevant reasons behind clusters.
