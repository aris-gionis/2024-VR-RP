...
\newcommand{\rto}{{\sf\small RT1}\xspace}
\newcommand{\rtw}{{\sf\small RT2}\xspace}
\newcommand{\rth}{{\sf\small RT3}\xspace}


\newcommand{\newmodels}{{Novel explainable models}}
\newcommand{\clusterings}{{Clustering beyond centroids}}
\newcommand{\labels}{{Labeled-induced explanations}}
