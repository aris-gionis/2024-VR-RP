...
\usepackage[margin=2.25cm,top=2cm,bottom=2cm]{geometry}
...
\usepackage{setspace}\linespread{1.0}
\usepackage{helvet}
...
\newcommand{\clusterings}{{Explainability beyond centroid-based clustering}}
\newcommand{\covariates}{{Explaining clustering with covariates}}

\newcommand{\posthoc}{{\sc PostHoc}\xspace}
\newcommand{\joint}{{\sc Joint}\xspace}
...
\newcommand{\tfidf}{\texttt{\small tf}\ensuremath{\cdot}\texttt{\small idf}\xspace}
\newcommand{\dataset}{\ensuremath{X}\xspace}
\newcommand{\reals}{\ensuremath{\mathbb{R}}\xspace}
\newcommand{\realsd}{\ensuremath{\reals^d}\xspace}
...
\newcommand{\alabel}{\ensuremath{{\ell}}\xspace}
